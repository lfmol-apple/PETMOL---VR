...
async def commerce_petz_direct_link(
    ...
    # mapa curado GTIN → id do produto Petz (`PETZ_GTIN_PRODUCT_ID`, ver
    # affiliate_links.py). Só quando a flag `petz_cart_prefill` está ON e
    # o produto tem GTIN conhecido. Não mexe em `direct_product_url` (isso
    # continua exigindo mapping confirmado) — só destrava as 2 URLs Struts.

      ...
      <PremiumCard>
        ...
        <div className="prose prose-sm prose-slate max-w-none">
          ...
          <ul>
            ...
            <li>Documentos enviados (fotos de carteirinha de vacinação, receitas, laudos) podem ser processados por inteligência artificial (Google Gemini) para extração automática de informações como nome da vacina e data — sempre com sua confirmação explícita antes do envio da foto (você pode optar por preencher manualmente, sem usar IA). O arquivo original é armazenado nos nossos servidores; conforme os termos de uso da Google para a API do Gemini, a imagem não é usada para treinar modelos e não é retida além do necessário para processar a requisição</li>
          </ul>
          ...
          <ul>
            ...
            <li><strong>APIs externas:</strong> Google Maps/Places (busca de estabelecimentos), Google Gemini (leitura automática de documentos e identificação de produtos por foto, sempre com sua confirmação prévia), Cosmos Bluesoft e GTIN (consulta de código de barras de produtos)</li>
          ...
          <ul>
            ...
            <li>Backups automáticos e regulares do banco de dados, armazenados de forma segura na infraestrutura de hospedagem; secrets/credenciais nos backups são sempre criptografados quando presentes</li>
          </ul>
